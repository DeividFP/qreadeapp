...
export 'package:qreaderapp/src/models/scan_model.dart'; //Sirve para exportar a los archivos donde se requiera db_provider.dart
...
class DBProvider{
  ...
  Future<ScanModel> getSacnId(int id) async{
    final db = await database;
